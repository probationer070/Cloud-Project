...
| 26-06-11 | upgrade | [P2 Textract Replaced with pypdf](26-06-11%20[upgrade]%20P2%20Textract%20Replaced%20with%20pypdf.md) | `project2-serverless-pipeline/lambda/extractor/index.py`, `iam.tf`, `main.tf`, `requirements.txt` (new), `README.md` ×2, `file-structure.md`, `docs/design/p2-*` |
| 26-06-11 | bug | [P5 uv Not Found Replaced with pip](26-06-11%20[bug]%20P5%20uv%20Not%20Found%20Replaced%20with%20pip.md) | `project5-document-engine/main.tf` |
| 26-06-11 | bug | [P5 Query Lambda Korean Prompt Translated to English](26-06-11%20[bug]%20P5%20Query%20Lambda%20Korean%20Prompt%20Translated%20to%20English.md) | `project5-document-engine/lambda/query/index.py` |